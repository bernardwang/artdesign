...
var _initGallery = require('./helper/initGallery');

global.app = function () {

	(0, _initGallery.initGallery)().then(function () {
...
},{"./helper/initGallery":193,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
...
var $http = function httpRequest(url) {
	// AJAX request, returns promise
	var ajax = function ajaxCall(method, url, args) {
...
exports.initGallery = undefined;

var _http = require('./http');

var callAPI = function callFlickrAPI() {
	...
	return (0, _http.$http)(url).get(args);
}; /**
    *
    *	XMLHttpRequest helper function
    *
...
var checkResponse = function checkAPIResponse(data) {
...
var initGallery = function initializeGallery() {
	return callAPI().then(checkResponse(data));
