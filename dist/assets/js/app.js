...
global.app = function () {
	...
	(0, _http.$http)(url).get(args).then(callback.success).catch(callback.error);
};
...
},{"./helper/http":192,"./model/Person":193,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
